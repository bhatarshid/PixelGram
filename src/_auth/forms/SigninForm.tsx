        ...
        <>
            <div className="flex flex-col items-center w-full">
                ...
                <section className="my-1">
                    <p className="font-serif text-[14px] text-white">Don't have account? <Link to='/sign-up' className="text-primary-500 text-blue-500 text-small-semibold ml-1">Sign up</Link></p>
                </section>
            </div>
        </>
    )
